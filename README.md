...
- **配布用パッケージの改善**: 設定ファイルを初期値に変更
- **Windowsインストーラーの修正**: 文字化け問題を解決
- **クリーンな状態での配布**: サンプルファイルを削除
- **バッチファイルの改善**: requirements.txtのパス問題を修正
...
- **v1.3.1** (2025-05-17)
  - 配布用パッケージの改善
  - Windowsインストーラーの文字化け修正
  - requirements.txtのパス問題を修正
